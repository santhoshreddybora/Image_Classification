...
from Components.data_ingestion import DataIngestion  # adjust import to match repo structure
...
def test_download_and_extract_data(mock_blob_service, mock_params):
    ...
    mock_blob_service.from_connection_string.return_value.get_blob_client.return_value = fake_blob
    mock_blob_service.from_connection_string.return_value.get_container_client.return_value = fake_container
...
def test_unzip_data(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("Components.data_ingestion.params", {
